            ...
            if (res.length >= 1) {
                res.forEach(item => {
                    result += `<div class="relative p-4 border m-2 rounded-lg border-gray-300">
                        <a class="group mt-2 block relative overflow-hidden rounded-lg border border-gray-400 justify-center flex"
                           href="/mypage/popup/view/${item.id}">
                            ...
                            <img class="sm:h-64 max-h-80 object-cover bg-gray-100"
