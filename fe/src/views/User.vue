        ...
        <form id="edit-user-form" class="min-w-5xl space-y-12 p-8 flex-col"
          ...
          <div class="flex sm:flex-row flex-col justify-between sm:space-y-0 space-y-4">
            ...
            <div class="flex flex-col justify-center items-center space-y-4">
              <img id="profile-image" :src="user[0].image" class="rounded-full w-40 h-40 border border-gray-300 object-cover bg-gray-300" alt="">
            ...
            <div class="flex flex-col space-y-4">
              ...
              <span v-if="role === 'landlord'" class="h-9 p-1 font-bold text-gray-700 flex-shrink-0">사업자등록번호 : {{ user[0].businessId }}</span>
            </div>
            <!-- 버튼 영역 -->
            <div class="flex justify-end items-end h-50">
              <button
                  @click="navigateToUserEdit(user[0])"
          ...
          <section class="mt-4 w-full px-4">
            ...
            <div class="border-2 max-w-full mx-auto rounded-2xl">
              <div class="flex justify-between items-center pl-8 pr-4 mt-2">
                ...
                <router-link
                    :to="role === 'landlord' ? `/user/land` : `/user/popup/`"
